...
public class MainActivity extends Activity {
    ...
    private void buildUi() {
        ...
        TextView hint = text("Tap the floating button to toggle. Drag it anywhere unless its position is frozen. Long-press it to reopen this screen.", 13, MUTED);
